    ...
    <div class="collapse navbar-collapse" id="menu">
        <ul class="navbar-nav mr-auto">
            ...
            @else
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route("property.index")}}">Inmuebles&nbsp;<i class="fa fa-box"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route("comprar.index")}}">Comprar Inmueble&nbsp;<i class="fa fa-cart-plus"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route("ventas.index")}}">Ventas&nbsp;<i class="fa fa-list"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route("user.index")}}">Usuarios&nbsp;<i class="fa fa-users"></i></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route("owner.index")}}">Propietarios&nbsp;<i class="fa fa-users"></i></a>
                </li>
            @endguest
        </ul>
